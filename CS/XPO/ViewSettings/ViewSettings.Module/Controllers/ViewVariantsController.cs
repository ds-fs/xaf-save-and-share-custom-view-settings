...
namespace ViewSettingsSolution.Module.Controllers
{
    public class ViewVariantsController : ViewController
    {
        ...
        public ViewVariantsController()
        {
            ...
            this.SelectViewVariantAction = new SingleChoiceAction(this, "Ansicht auswählen", PredefinedCategory.View) { ImageName = "Navigation_Item_ViewVariant", PaintStyle = ActionItemPaintStyle.Image };
        ...
        private void UpdateActions(string itemToSelectCaption)
        {
            ...
            var criteria = CriteriaOperator.FromLambda<ViewSettingsStore>(x => x.ViewId == View.Id && (x.IsShared || x.OwnerId == null || x.OwnerId == currentUserId));
